...
extension Color {
    ...
    // Sleepy Lumi Palette (from your CSS)
    ...
    static let sl_bgLumiMessage = Color(hex: "#2a303b")
    static let sl_bgUserMessage = Color(hex: "#1e222b")

    static let sl_textPrimary = Color(hex: "#b0bac4")
    static let sl_textSecondary = Color(hex: "#7d8590")
    static let sl_textPlaceholder = Color(hex: "#9ab")
    static let sl_textPlaceholderFocus = Color(hex: "#789")
    ...
    static let sl_borderAccent = Color(hex: "#58a6ff") // For active chat item border

    static let sl_errorBg = Color(hex: "#4d2226")
    static let sl_errorText = Color(hex: "#f8d7da")
    
    static let sl_bgDanger = Color(hex: "#c53030") // For stop button
    
    static let sl_infoBg = Color(hex: "#1f242e").opacity(0.7) // Example for info messages

    // Original glow color from CSS: 190, 210, 245
